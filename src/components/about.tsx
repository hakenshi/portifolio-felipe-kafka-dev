...
export default function About() {
    return (
        <Section id='about'>
            <div className='bg-zinc-900/50 w-full border-y border-y-zinc-800'>
                <div className='text-center px-4 py-8'>
                    <h2 className='text-2xl sm:text-3xl lg:text-4xl font-bold mb-4'>About me</h2>
                    <p className='text-lg sm:text-xl text-zinc-600 max-w-3xl mx-auto'>I'm a developer focused on building and developing web applications</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="text-zinc-400 leading-relaxed space-y-4 text-sm sm:text-base">
                            ...
                            <div>
                                <h3 className='text-xl sm:text-2xl font-semibold mb-4'>Philosophy</h3>
                                <div className="text-zinc-400 leading-relaxed space-y-4 text-sm sm:text-base">
                        ...
                        <div>
                            <h3 className="text-xl sm:text-2xl font-semibold mb-6">My Skills</h3>
                            <div className="flex flex-wrap gap-2 sm:gap-3">
                                {technologies.map((t, i) => (
                                    <span key={i} className="bg-red-900/30 border-red-700/40 text-red-300 border px-3 py-1.5 rounded-full shadow backdrop-blur-2xl text-sm">{t}</span>
                                ))}
                            </div>
                        </div>
                    </div>
